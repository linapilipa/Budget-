        ...
        while (runProgram) {
            ...
            switch (input) {
                case "p" -> {
                    ...
                    biudzetas.pridetiPajamauIrasa(pajamuSuma, kategorija, data, gauta);
                }
                case "i" -> {
                    float islaiduSuma;
                    System.out.println("Įveskite sumą: ");
                    ...
                    biudzetas.pridetiIslaiduIrasa(islaiduSuma, kategorija, dataLaikas, atsiskaitymoBudas, mokejimoKortele);
                }
